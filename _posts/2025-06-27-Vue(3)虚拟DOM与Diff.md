...
## 目录
- [虚拟DOM](#1-虚拟dom)
- [从template到虚拟DOM](#2-从template到虚拟dom)
- [Vue2的Diff算法](#3-vue2-的-diff-算法)
- [Vue3的Diff算法](#4-vue3-的-diff-算法)
- [Vue2和Vue3的Diff算法对比](#5-vue2-和-vue3-的-diff-算法对比)
- [Vue Diff vs React Diff](#6-vue-diff-vs-react-diff)
...
![vue2-diff](/images/post-assets/vue2Diff.png)
...
![vue3-diff](/images/post-assets/vue3Diff.png)
图源：[掘金：说说 vue2 和 vue3 核心diff算法](https://juejin.cn/post/7092068900589797413)
...
## 参考资料
- [掘金：说说 vue2 和 vue3 核心diff算法](https://juejin.cn/post/7092068900589797413)